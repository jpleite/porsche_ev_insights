...
export const es = {
  ...
  insights: {
    ...
    notEnoughData: 'No hay suficientes datos para mostrar proyecciones. Añade más datos de viajes (al menos 1 mes) para ver estimaciones anuales y estacionales.',
